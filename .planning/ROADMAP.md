...
| 46. Google Tasks Full-List Sync | v1.9 | 0/5 | Planning | — |
...
Plans:
- [ ] 46-01-PLAN.md — gtasks service layer (getAllTaskLists, getTaskItemsInWindow) + GET /api/google-tasks/lists + /items routes + vitest
